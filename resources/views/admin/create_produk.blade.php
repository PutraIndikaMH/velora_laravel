    ...
    <div class="container form-container">
        ...
        <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="product_description" name="product_description" rows="3" required>{{ old('product_description') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="url" class="form-control" id="recommendation_links" name="recommendation_links"
                    value="{{ old('recommendation_links') }}" required>
            </div>

            <div class="mb-3">
                <label for="image_name" class="form-label">Gambar Produk</label>
